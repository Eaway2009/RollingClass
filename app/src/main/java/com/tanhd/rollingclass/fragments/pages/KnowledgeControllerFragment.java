...
public class KnowledgeControllerFragment extends Fragment {

    private Callback mListener;

    public static KnowledgeControllerFragment newInstance(int pageId, KnowledgeControllerFragment.Callback callback) {
