package com.tanhd.rollingclass.views.popmenu;
...
public class DropPopMenu {
    ...
    private void init() {
        ...
        mMarginWidth = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_margin);
    ...
    private void initListView() {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT
                , LinearLayout.LayoutParams.WRAP_CONTENT);
        params.leftMargin = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_margin);
        params.rightMargin = (int) mContext.getResources().getDimension(R.dimen.drop_pop_menu_margin);
        mListView.setLayoutParams(params);
        mListView.setDivider(new ColorDrawable(0xFFFFFFFF));
    ...
    private class DropPopMenuAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View view, ViewGroup viewGroup) {
            ...
            if (position == 0) {
                mWidth = mMaxTextWidth + mHorizontalMargin * 2 + mMarginWidth * 2;
                if (!iconIsGone) {
